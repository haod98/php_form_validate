...
<body>
    ...
    <?php else : ?>
        <p class="afterSubmit">Thank you for your submission</p>
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-check-circle check" viewBox="0 0 16 16">
